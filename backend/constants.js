...
const CMD_SYNC_PUT_SESSION = 194
const CMD_SYNC_PUT_SETTINGS = 195
const CMD_SYNC_APPLY_SETTINGS = 196
const CMD_SYNC_PUT_PROFILE = 197
const CMD_SYNC_APPLY_PROFILE = 198
const CMD_SYNC_PUT_HISTORY = 199
const CMD_SYNC_APPLY_HISTORY = 202
const CMD_SYNC_PUT_CONTACTS = 203
const CMD_SYNC_APPLY_CONTACTS = 204
const CMD_SYNC_PUT_APP_GRANTS = 205
const CMD_SYNC_APPLY_APP_GRANTS = 206
const CMD_SYNC_FORGET = 207
const CMD_SYNC_ROTATE = 208
const CMD_SYNC_GET_INVITE = 209
...
const CMD_SHIP_CHECK = 214   // { kind:'app'|'site', manifest/site draft } → publisher diagnostics report
const CMD_TRUST_SUMMARY = 215 // { kind:'app'|'site', app/site, driveKey? } → compact Trust Center DTO
const CMD_SYNC_COMPACT = 216 // writer-only encrypted device-sync checkpoint + local view pruning
const CMD_RUN_FRESH_PEER_VERIFY = 217 // { key|driveKey|link, samples?, timeout? } → in-app isolated fresh-peer verifier result
...
module.exports = {
  ...
  CMD_NAVIGATE, CMD_GET_STATUS, CMD_GET_DRIVE_INFO, CMD_GET_DRIVE_INFOS,
  ...
  CMD_SYNC_PUT_SESSION, CMD_SYNC_PUT_SETTINGS, CMD_SYNC_APPLY_SETTINGS,
  CMD_SYNC_PUT_PROFILE, CMD_SYNC_APPLY_PROFILE, CMD_SYNC_PUT_HISTORY, CMD_SYNC_APPLY_HISTORY,
  CMD_SYNC_PUT_CONTACTS, CMD_SYNC_APPLY_CONTACTS, CMD_SYNC_PUT_APP_GRANTS, CMD_SYNC_APPLY_APP_GRANTS,
  CMD_SYNC_FORGET, CMD_SYNC_ROTATE, CMD_SYNC_GET_INVITE, CMD_SYNC_COMPACT,
  ...
  CMD_SUBMIT_APP, CMD_MOD_PENDING, CMD_MOD_APPROVE, CMD_MOD_REJECT, CMD_SHIP_CHECK, CMD_TRUST_SUMMARY,
  CMD_RUN_FRESH_PEER_VERIFY,
  CMD_BRIDGE,
  CMD_STOP,
