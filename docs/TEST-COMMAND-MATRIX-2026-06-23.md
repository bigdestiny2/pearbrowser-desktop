...
- `npm test` passed: 427 tests, 0 failed.

This supersedes older local counts in nearby docs for this checkout. The
current release-readiness docs and latest rerun agree on 427/427.
...
| `npm test` | Full desktop Node test suite: `node --test 'test/*.test.js'` | Passed, 427/427 |
