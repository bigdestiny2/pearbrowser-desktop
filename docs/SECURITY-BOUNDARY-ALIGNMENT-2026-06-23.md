...
- `docs/TEST-COMMAND-MATRIX-2026-06-23.md` supersedes older test-count claims.
  The current release branch records `npm test` at 457/457 after the runtime
  storage gate, release story smoke, native release asset checker/resolver,
  native download verifier, native install snippet generator, native
  public-trust workflow mode, macOS public-trust DMG gate, and vendored
