...
node scripts/release-rpc-story-smoke.mjs --timeout 45000 --request-timeout 30000 --local-stories --json # after launching PearBrowser; latest live run passed: homepage HTTP 200/90770 bytes, 2 catalogues, 14 apps, Keet/PearPass/anonGPT/Paste/Peercord present, Peercord standalone/window-only, local search first-paint, curated/petname naming, bookmark/session round-trip; no third-party app launched, trust approved, or test site published
