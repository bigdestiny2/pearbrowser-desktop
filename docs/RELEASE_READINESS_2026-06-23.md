...
npm run -s generate:native-signing-secret-plan -- --repo bigdestiny2/pearbrowser-desktop --tag v0.5.0 --source-ref <merged-main-commit> # emits the public-trust GitHub Actions secret inventory, gh secret set command templates, and follow-up signing/readiness checks for the credential-holding operator
