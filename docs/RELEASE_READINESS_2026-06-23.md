...
- Desktop GitHub Actions CI is now present: `.github/workflows/desktop-ci.yml` checks out PearBrowser plus `bigdestiny2/P2P-Hiverelay@v0.16.3`, verifies the local workspace layout, runs `npm ci`, runs the desktop test suite, and runs the high-severity dependency audit.
